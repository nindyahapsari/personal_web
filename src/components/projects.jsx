  ...
  render() {
    return (
      <div
        ...
        id="container-work"
        style={{ backgroundImage: "url(images/background/project_bg.png)" }}
      >
          ...
          <div className="project-card plant">
            ...
            <div className="overlay">
              ...
              >
                <i className="fab fa-github" id="githubProject" />
                <p className="click">click for source code</p>
                <div className="project-text plant" id="plantdetectapptext">
          ...
          <div className="project-card">
            ...
            <div className="overlay">
              ...
              >
                <i className="fab fa-github" id="githubProject" />
                <p className="click">click for source code</p>
                <div className="project-text personal" id="personalwebtext">
